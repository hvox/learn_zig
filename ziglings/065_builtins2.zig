...
pub fn main() void {
    ...
    // We cannot leave the 'me' and 'myself' fields
    // undefined. So I set them here:
    ...
    // This function is namespaced to the struct, but doesn't
    // use the method syntax (there's no self parameter).
